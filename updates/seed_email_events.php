...
class SeedEmailEvents extends Seeder
{
    public function run()
    {
        $events = [
            ...
            [
                ...
                'enabled' => true,
                'priority' => 10,
                'context_vars' => json_encode(['order_id', 'order_number', 'user', 'total', 'items'])
            ],
            [
                ...
                'enabled' => true,
                'priority' => 8,
                'context_vars' => json_encode(['order_id', 'order_number', 'user'])
            ],
            [
                ...
                'enabled' => true,
                'priority' => 7,
                'context_vars' => json_encode(['order_id', 'order_number', 'user', 'reason'])
            ],
            ...
            [
                ...
                'enabled' => true,
                'priority' => 9,
                'context_vars' => json_encode(['invoice_id', 'invoice_number', 'user', 'total', 'due_date'])
            ],
            [
                ...
                'enabled' => true,
                'priority' => 10,
                'context_vars' => json_encode(['invoice_id', 'invoice_number', 'user', 'amount', 'payment_method'])
            ],
            [
                ...
                'enabled' => true,
                'priority' => 8,
                'context_vars' => json_encode(['invoice_id', 'invoice_number', 'user', 'total', 'days_overdue'])
            ],
            ...
            [
                ...
                'enabled' => true,
                'priority' => 10,
                'context_vars' => json_encode(['payment_id', 'user', 'amount', 'method', 'invoice_id'])
            ],
            [
                ...
                'enabled' => true,
                'priority' => 9,
                'context_vars' => json_encode(['payment_id', 'user', 'amount', 'error_message'])
            ],
            ...
            [
                ...
                'enabled' => true,
                'priority' => 9,
                'context_vars' => json_encode(['cloud_id', 'user', 'service', 'plan', 'credentials'])
            ],
            [
                ...
                'enabled' => true,
                'priority' => 8,
                'context_vars' => json_encode(['cloud_id', 'user', 'reason', 'suspension_date'])
            ],
            [
                ...
                'enabled' => true,
                'priority' => 7,
                'context_vars' => json_encode(['cloud_id', 'user', 'expiration_date', 'days_left'])
            ],
            [
                ...
                'enabled' => true,
                'priority' => 9,
                'context_vars' => json_encode(['cloud_id', 'user', 'expiration_date'])
            ],
            ...
            [
                ...
                'enabled' => true,
                'priority' => 8,
                'context_vars' => json_encode(['domain_name', 'user', 'registration_date', 'expiration_date'])
            ],
            [
                ...
                'enabled' => true,
                'priority' => 7,
                'context_vars' => json_encode(['domain_name', 'user', 'expiration_date', 'days_left'])
            ],
            [
                ...
                'enabled' => true,
                'priority' => 8,
                'context_vars' => json_encode(['domain_name', 'user', 'expiration_date'])
            ],
            ...
            [
                ...
                'enabled' => true,
                'priority' => 9,
                'context_vars' => json_encode(['ticket_id', 'user', 'subject', 'department', 'priority'])
            ],
            [
                ...
                'enabled' => true,
                'priority' => 8,
                'context_vars' => json_encode(['ticket_id', 'user', 'subject', 'reply_content', 'author'])
            ],
            ...
            [
                ...
                'enabled' => true,
                'priority' => 7,
                'context_vars' => json_encode(['task_id', 'title', 'assignee', 'due_date', 'priority'])
            ],
            [
                ...
                'enabled' => true,
                'priority' => 6,
                'context_vars' => json_encode(['task_id', 'title', 'completed_by', 'completion_date'])
            ],
            ...
            [
                ...
                'enabled' => true,
                'priority' => 8,
                'context_vars' => json_encode(['user_id', 'name', 'email', 'registration_date'])
            ],
        ];
