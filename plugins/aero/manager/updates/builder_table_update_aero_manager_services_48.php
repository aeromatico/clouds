...
class BuilderTableUpdateAeroManagerServices48 extends Migration
{
    public function up()
    {
        Schema::table('aero_manager_services', function($table)
        {
            ...
            $table->boolean('pricing_on')->default(0)->change();
            $table->boolean('addons_on')->default(0)->change();
            $table->boolean('faqs_on')->default(0)->change();
            $table->boolean('plans_on')->default(0)->change();
    ...
    public function down()
    {
        Schema::table('aero_manager_services', function($table)
        {
            ...
            $table->string('button2_text', 191)->default('\'null\'')->change();
            $table->string('button2_link', 191)->default('\'null\'')->change();
            $table->boolean('pricing_on')->default(null)->change();
            $table->boolean('addons_on')->default(null)->change();
            $table->boolean('faqs_on')->default(null)->change();
            $table->boolean('plans_on')->default(null)->change();
