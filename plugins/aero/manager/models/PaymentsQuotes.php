 ...
 * Model
 */
class PaymentsQuotes extends Model
{
     ...
     */
    public $table = 'aero_manager_payments_quotes';
    ...
    protected $jsonable = ['chat','gateways','fee_ext_detail'];
...
https://boliviahost.com/dashboard/soporte/exchange/chat/".$this->identifier."
...
El equipo de soporte
        ";
         ...
         $vars = ['name' => "hola",'identifer' =>$this->identifier,'type'=>'pagos','invoice'=>$this->id];
