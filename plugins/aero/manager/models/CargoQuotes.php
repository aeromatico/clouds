 ...
 * Model
 */
class CargoQuotes extends Model
{
     ...
     */
    public $table = 'aero_manager_cargo_quotes';
    ...
    protected $jsonable = ['urls','chat','fee_ext_detail'];

    public function beforeCreate()
    {
        $this->identifier = Crypt::encryptString(uniqid());
    }
...
https://boliviahost.com/dashboard/soporte/cargo/chat/".$this->identifier."
...
El equipo de soporte
    ...
    // Plugin::sendSmsWhatsapp($user->mobile,$message);
       $vars = ['name' => "hola",'identifer' =>$this->identifier,'type'=>'cargo','invoice'=>$this->id];
